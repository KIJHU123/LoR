...
gdjs.GraCode.mapOfGDgdjs_46GraCode_46GDkostkaObjects1Objects = Hashtable.newFrom({"kostka": gdjs.GraCode.GDkostkaObjects1});gdjs.GraCode.mapOfGDgdjs_46GraCode_46GDPlayerObjects1Objects = Hashtable.newFrom({"Player": gdjs.GraCode.GDPlayerObjects1});gdjs.GraCode.mapOfGDgdjs_46GraCode_46GDkostkaObjects1Objects = Hashtable.newFrom({"kostka": gdjs.GraCode.GDkostkaObjects1});gdjs.GraCode.eventsList0x695e50 = function(runtimeScene) {
...
}; //End of gdjs.GraCode.eventsList0x695e50
gdjs.GraCode.mapOfGDgdjs_46GraCode_46GDkostka2Objects1Objects = Hashtable.newFrom({"kostka2": gdjs.GraCode.GDkostka2Objects1});gdjs.GraCode.eventsList0x664da8 = function(runtimeScene) {
...
{gdjs.evtTools.object.createObjectOnScene((typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : runtimeScene), gdjs.GraCode.mapOfGDgdjs_46GraCode_46GDkostka2Objects1Objects, gdjs.random(580), 800, "");
...
}; //End of gdjs.GraCode.eventsList0x664da8
gdjs.GraCode.mapOfGDgdjs_46GraCode_46GDPlayerObjects1Objects = Hashtable.newFrom({"Player": gdjs.GraCode.GDPlayerObjects1});gdjs.GraCode.mapOfGDgdjs_46GraCode_46GDkostka2Objects1Objects = Hashtable.newFrom({"kostka2": gdjs.GraCode.GDkostka2Objects1});gdjs.GraCode.eventsList0x664808 = function(runtimeScene) {
...
}; //End of gdjs.GraCode.eventsList0x664808
...
{
for(var i = 0, k = 0, l = gdjs.GraCode.GDPlayerObjects1.length;i<l;++i) {
    if ( gdjs.GraCode.GDPlayerObjects1[i].getX() <= 580 ) {
        gdjs.GraCode.condition1IsTrue_0.val = true;
        gdjs.GraCode.GDPlayerObjects1[k] = gdjs.GraCode.GDPlayerObjects1[i];
        ++k;
    }
...
{for(var i = 0, len = gdjs.GraCode.GDPlayerObjects1.length ;i < len;++i) {
    ...
    gdjs.GraCode.GDkostkaObjects1[i].setPosition(gdjs.random(580),0);
}
}{for(var i = 0, len = gdjs.GraCode.GDkostka2Objects1.length ;i < len;++i) {
    gdjs.GraCode.GDkostka2Objects1[i].hide();
}
}{for(var i = 0, len = gdjs.GraCode.GDkostka2Objects1.length ;i < len;++i) {
    gdjs.GraCode.GDkostka2Objects1[i].setPosition(gdjs.random(580),800);
}
}}
...
{gdjs.evtTools.object.createObjectOnScene((typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : runtimeScene), gdjs.GraCode.mapOfGDgdjs_46GraCode_46GDkostkaObjects1Objects, gdjs.random(580), 0, "");
...
{ //Subevents
gdjs.GraCode.eventsList0x695e50(runtimeScene);} //End of subevents
}
...
{ //Subevents
gdjs.GraCode.eventsList0x664da8(runtimeScene);} //End of subevents
}
...
{ //Subevents
gdjs.GraCode.eventsList0x664808(runtimeScene);} //End of subevents
}
